...
class ChatBox:
    ...
    def draw(self, screen):
        ...
        if self.is_active:
            ...
            pygame.draw.rect(
                chat_surface, (0, 0, 0, 200), (0, 0, self.width, self.height)
            )
            pygame.draw.rect(
                chat_surface, self.border_color, (0, 0, self.width, self.height), 1
            )
            ...
            pygame.draw.rect(
                chat_surface,
                input_color,
                (2, input_y, self.width - 4, self.input_area_height),
            )
